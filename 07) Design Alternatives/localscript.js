/* Javascript for 07 Design Alternatives */
...
function G1_out(){
  ...
  var c = document.getElementById("R3C2");
  var d = document.getElementById("R4C4");
  a.style.background = "#fefad6";
  b.style.background = "#fefad6";
  c.style.background = "#fefad6";
  d.style.background = "#fefad6";
}

/* Function for Game 2
********************************************/
function G2_in(){
  var a = document.getElementById("R1C3");
  var b = document.getElementById("R1C4");
  var c = document.getElementById("R2C1");
  var d = document.getElementById("R3C2");
  a.style.background = "#fbed6a";
  b.style.background = "#fbed6a";
  c.style.background = "#fbed6a";
  d.style.background = "#fbed6a";
